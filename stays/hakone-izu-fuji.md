# Where to stay — Hakone · Izu · Fuji

*Japan Trip Kit · open this file only when **Hakone · Izu · Fuji** is on the plan. It is an INDEX, not a table: the inns you can reach from here and this place's hotels. The full row for any inn is in the master table in `stages/4-where-to-stay.md`, which you should have read first.*
...
_No hotel rows for Hakone · Izu · Fuji: the kit's hotel research does not reach here, and the inns above are the answer. A city night here is a hotel found live (`guides/research-method.md`), presented as a row of the same table and marked unverified._
