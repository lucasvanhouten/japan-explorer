<!-- Japan Trip Kit — Stage 3 — Walk one spine. GENERATED by planning/build-kit.js; never hand-edit. -->
*Japan Trip Kit · **Stage 3 — Walk one spine**. If you have not read `START-HERE.md`, read it first — it carries the instructions, the interview and the map of which file belongs to which stage. Read this file when you reach this stage, and no other stage file at the same time.*
