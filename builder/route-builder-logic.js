...
const LEGS={
  ...
  "kurokawa>fukuoka":L(2.5,0,"car","Rental car ~117 km / ~2h30: R212 to Hita IC, Ōita Expwy → Tosu JCT → Kyushu Expwy → Dazaifu IC (Kurokawa Onsen Ryokan Association and Ichinoi access pages, 2026-09-13). Studless tyres Dec–Feb. Without a car: the direct highway bus Kurokawa→Hakata (~2.5–3h, reserve).",{car:1,drive:1}),
  ...
  "unzen>nagasaki":L(1.25,0,"car","Rental car ~47 km / ~1h15 (R57 down the mountain → Chijiwa → Isahaya → Nagasaki) — only the top ~10 km of the descent carries ice risk (owner: Unzen assumes a car, 2026-09-13). Without a car: Ken-ei bus Unzen→Nagasaki (~1h40), or back to Isahaya and Ltd Exp on.",{car:1,drive:1}),
